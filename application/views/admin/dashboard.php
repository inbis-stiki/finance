                    ...
                    <div class="row">
                        <div class="col">
                            <div class="alert alert-'.$statusAlert.'">
                                ...
                                Jatuh tempo pembayaran pajak STNK nomor kendaraan '.$item->kendaraan_stnk.' adalah '.date_format($jatuhTempo, "j F Y").', <a href="#" class="alert-link">cek detail</a>
                            </div>
                        </div>
                    </div>        
                ';
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="alert alert-'.$statusAlert.'">
                                ...
                                Jatuh tempo pembayaran pajak KIR nomor kendaraan '.$item->kendaraan_stnk.' adalah '.date_format($jatuhTempo, "j F Y").', <a href="#" class="alert-link">cek detail</a>
                            </div>
                        </div>
                    </div>        
                ';
